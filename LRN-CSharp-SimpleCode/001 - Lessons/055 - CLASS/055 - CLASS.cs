...
namespace _055___CLASS
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
             ...
             * 
             * Для того чтобы работать с классом, необходимо создать экземпляр класса.
             ...
             * Эти методы являются чатью концепции ООП - "Наследование".
             * Любой объект в C# является наследником типа данных "object".
             ...
             * Для этого в SolutionExplorer необходимо нажать ПКМ по нужному проекту, выбрать add,
             ...
             *      модификатор class название_класса
             *      {
             *          тело класса которое определяет сосояние и поведение класса
             *      }
             *      
             * Тело класса может содержать: Поля (Fields), Свойства (Properties), Методы (Methods),
             * Конструкторы (Constructors), Деструкторы (Destructors), События (Events) и многое другое...
             * 
             * Пример класса:
             *      public class Person
             *      {
