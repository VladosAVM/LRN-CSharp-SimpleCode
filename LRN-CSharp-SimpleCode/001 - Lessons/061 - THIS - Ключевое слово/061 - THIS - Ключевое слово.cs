...
namespace _061___THIS___Ключевое_слово
{
    class Student
    {
        public Student(string lastName, DateTime birthDate)
        {
            ...
            // в поле класса в текущем экземпляре
            this.lastName = lastName;
            this.birthDate = birthDate;
        }

        // Использование Инициализатора Конструктора (:) для вызова Цепочки Конструкторов
        // Конструкция : this() - вызывает Цепочку Конструкторов
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             *           class x
             *           {
             *               public x(string firstName)
             *               {
             *                  this.firstName = firstName;
             *               }
             *               
             *               public x(string firstName, string lastName) : this(firstName)
             *               {
             *                   this.lastName = lastName;
             *               }
             *               
