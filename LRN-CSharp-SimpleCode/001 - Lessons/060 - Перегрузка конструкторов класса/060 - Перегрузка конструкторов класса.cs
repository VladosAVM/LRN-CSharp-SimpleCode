...
namespace _060___Перегрузка_конструкторов_класса
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * 
             * Конструктор копирования — это не паттерн проектирования, а стандартная ООП-практика,
             * удобная для копирования объектов и изоляции их состояний.
             * Относится к категории "идиом" или "приёмов ООП"
             * 
             * Он используется для:
             *  - Создания копии объекта с теми же данными.
             *  - Избежания работы с одной и той же ссылкой
             *    (например, чтобы изменения в одном объекте не влияли на другой).
             *  - Упрощения дублирования логики инициализации.
             */
