...
namespace _062___GET_SET___Геттеры_и_Сеттеры___Свойства_класса
{
     ...
     * К томуже она позволяет не вызывать методоы, а обращаться напрямую к приватному полю через
     ...
     * которую ранее приходилось обходить при помощи ключевого слова this
     */
    ...
    // Демонстрация некоторых возможных модификаций Свойста Коасса и Аксессоров get и set
    class PossibleModifiersForGetterSetter
    {
     ...
     // private string A - если тип данны не совпадает то свойство работать не будет
        ...
        // 4. Модификаторы protected internal и private protected тоже работают — но подчиняются тем же правилам
        private int b = 20;
        public int B
        {
