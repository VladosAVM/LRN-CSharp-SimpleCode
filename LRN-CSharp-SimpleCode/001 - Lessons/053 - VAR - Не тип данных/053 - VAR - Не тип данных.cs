...
namespace _053___VAR___Не_тип_данных
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * Определение типа данных к которому будет принадлежать переменная var,
             * определяется в момент инициализации.
             * В дальнейшем в эту переменную необходимо будет присваивать значения того типа
             * который был определён при инициализации. Присвоение другого типа данных невозможо.
             */
            ...
            // var применяется при создании Объектов, Классов, Коллекций....
            ...
            // НЕ может быть аргументов метода
