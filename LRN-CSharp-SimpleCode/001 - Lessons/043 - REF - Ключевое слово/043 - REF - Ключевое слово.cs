...
namespace _043___REF___Ключевое_слово
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
             ...
             * переменной a.Main остаются прежними т.е. a = 2.
             * Это происходит по причине того что наш мето не возвращает значение, а также
             ...
             * хранить ссылку.
             *
             * Для того чтобы уничтожит или изменить ссылку необходимо передать её с
             * помощью ref.
             * 
             ...
             * 
             * Если мы при создании метода укажим ключевое слово ref перед типом 
